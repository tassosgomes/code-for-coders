...
**Descrição:** o que chega sem identificação do fato, sem domínio de origem ou sem tenant não pode ser
registrado como ato — não há como garantir RF-02, dizer de onde veio nem a quem pertence (RN-A13). Essa mensagem não vira registro: ela é
...
| DP-04 | Tipo de ato desconhecido é tratado como não conforme, não recusado | Recusar — um domínio que passe a publicar antes de o tipo ser aceito perderia atos | RF-03 | Derivada de DP-03; confirmada em 2026-09-24 |
| DP-05 | Mensagem sem identificação do fato, sem origem ou sem tenant não vira registro: fica retida intacta e é alertada | Registrá-la como não conforme — sem identificação não há como evitar duplicidade, e a trilha passaria a guardar coisas que não são atos | RF-04 | Confirmada em 2026-09-24 |
...
|---|---|---|
| 1.0 | 2026-09-24 | Versão aprovada |
| 1.1 | 2026-09-24 | RF-04 e DP-05: ato sem tenant é ilegível (RN-A13), decidido na TechSpec |
