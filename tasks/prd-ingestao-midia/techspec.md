...
status: approved
updated: 2026-09-26
sources: tasks/prd-ingestao-midia/prd.md@1.0, tasks/prd-ingestao-midia/contracts.md@1.1
---
...
> - **Contratos:** [contracts.md](contracts.md) 1.1 — [OpenAPI SPA → BFF 1.1.1](api-contract.yaml), [OpenAPI BFF → Media 1.0.1](internal-api-contract.yaml), [AsyncAPI Media 1.0.0](asyncapi-contract.yaml)
> - **Data:** 2026-09-26
> - **Status:** Aprovado em 2026-09-26
> - **Handoff:** approved — design da área Vídeos (EN-02) antes do código de tela
...
| Armazenamento indisponível na API | 503 | `STORAGE_UNAVAILABLE` (C-16, contrato interno 1.0.1) |
| Media indisponível ou 5xx de Media, no BFF | 502 | `MEDIA_UNAVAILABLE` (C-16, contrato público 1.1.1) |
| Media sem resposta no tempo limite, no BFF | 504 | `MEDIA_UNAVAILABLE` (C-16) |
...
- [x] **Armazenamento indisponível na API** — resolvida em 2026-09-26 (C-16): 503 `STORAGE_UNAVAILABLE` em
  Media nas operações que falam com o armazenamento; 502/504 `MEDIA_UNAVAILABLE` no BFF. Contratos 1.1.1
  (BFF) e 1.0.1 (Media).
- [ ] **QP-02 — nome e posição da área** — design, em EN-02 (task de design antes do código de tela) — só navegação.
...
- [ADR-0006: Preparação de vídeo em worker próprio do media e custódia da chave HLS](../../docs/adr/0006-preparacao-de-video-e-custodia-de-chave.md) — nova, **Accepted** em 2026-09-26.
