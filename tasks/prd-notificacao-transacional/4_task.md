...
- [ ] Gate passa (exit 0): `dotnet test src/notification/tests/CodeForCoders.Notification.IntegrationTests/CodeForCoders.Notification.IntegrationTests.csproj -- --filter-class "CodeForCoders.Notification.IntegrationTests.DeliverPasswordRecoveryEmailTests" --minimum-expected-tests 1`
- [ ] Pedido com `finalidade: recuperacao-de-senha` termina em Registro de Entrega "entregue" com a
      finalidade correta, e-mail com o link e a validade do parâmetro próprio de recuperação, sem
      link de descadastro
- [ ] A suíte completa das Tasks 1.0–3.0 continua passando sem alteração de arquivo fora dos listados
      acima (evidência do Objetivo 3 do PRD)
