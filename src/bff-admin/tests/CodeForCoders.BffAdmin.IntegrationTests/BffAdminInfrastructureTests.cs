...
public sealed class BffAdminInfrastructureTests(BffAdminIntegrationFixture fixture)
{
    [Fact]
    public async Task HeartbeatFlowsThroughOutboxRabbitMqAndConsumer()
    {
        ...
        var configurationValues = new Dictionary<string, string?>
        {
            ...
            ["RabbitMq:Exchange"] = "bff-admin.integration.events",
            ["RabbitMq:DeadLetterExchange"] = "bff-admin.integration.events.dlx",
            ["RabbitMq:HeartbeatQueue"] = "bff-admin.integration.platform-heartbeat",
