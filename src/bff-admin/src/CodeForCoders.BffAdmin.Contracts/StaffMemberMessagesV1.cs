...
public sealed record StaffRoleActionRequestV1(string? Role, string? Reason);

public sealed record StaffRoleChangeRequestV1(string? FromRole, string? ToRole, string? Reason);
