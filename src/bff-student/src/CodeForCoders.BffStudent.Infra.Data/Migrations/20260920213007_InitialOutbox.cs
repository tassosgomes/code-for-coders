...
public partial class InitialOutbox : Migration
{
    ...
    {
        migrationBuilder.EnsureSchema(name: "bff_student_access");

        migrationBuilder.CreateTable(
            name: "outbox_messages",
            schema: "bff_student_access",
            columns: table => new
            {
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
        => migrationBuilder.DropTable(name: "outbox_messages", schema: "bff_student_access");
}
