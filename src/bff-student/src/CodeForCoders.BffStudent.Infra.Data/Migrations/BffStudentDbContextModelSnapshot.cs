...
namespace CodeForCoders.BffStudent.Infra.Data.Migrations;

[DbContext(typeof(BffStudentDbContext))]
sealed partial class BffStudentDbContextModelSnapshot : ModelSnapshot
{
    protected override void BuildModel(ModelBuilder modelBuilder)
    {
#pragma warning disable 612, 618
        modelBuilder
            .HasDefaultSchema("bff_student_access")
            .HasAnnotation("ProductVersion", "10.0.12")
            .HasAnnotation("Relational:MaxIdentifierLength", 63);

        NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);

        modelBuilder.Entity("CodeForCoders.BffStudent.Infra.Data.Outbox.OutboxMessage", b =>
        {
            ...
            b.ToTable("outbox_messages", "bff_student_access");
        });
