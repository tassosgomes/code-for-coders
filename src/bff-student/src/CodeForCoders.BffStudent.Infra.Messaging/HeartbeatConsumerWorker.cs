    ...
    ILogger<HeartbeatConsumerWorker> logger) : BackgroundService
{
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await channel.BasicConsumeAsync(options.Value.HeartbeatQueue, autoAck: false, consumer, cancellationToken: stoppingToken);
    ...
    private sealed class HeartbeatConsumer : AsyncDefaultBasicConsumer
    {
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                var heartbeat = JsonSerializer.Deserialize<PlatformHeartbeatV1>(body.Span, new JsonSerializerOptions(JsonSerializerDefaults.Web));
                ...
                BffStudentTelemetry.HeartbeatsConsumed.Add(1);
            ...
            Guid eventId)
        {
            ...
            return RabbitMqTelemetry.ActivitySource.StartActivity(
                "bff-student.platform.heartbeat.consume",
