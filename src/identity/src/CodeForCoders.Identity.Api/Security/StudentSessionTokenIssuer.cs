...
public sealed class StudentSessionTokenIssuer(
    IOptions<StudentSessionTokenOptions> options,
    TimeProvider timeProvider)
{
    ...
    public string Create(string audience, Guid tenantId, Guid accountId, Guid sessionId)
    {
        ...
        {
            throw new InvalidOperationException("The requested student session audience is not configured.");
        }
